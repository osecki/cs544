...
public class UDPTransmitter extends Thread{
	...
	public UDPTransmitter(MediaLocator locator,
			String ipAddress,
			String pb,
			Format format) {
	 ...
	 */
	public synchronized String startTx() {
		String result;
	...
	private String createTransmitter() {
		...
		for (int i = 0; i < pbss.length; i++) {
			try {
				...
				//uses same local port as remote port
				//localAddr = new SessionAddress( InetAddress.getLocalHost(),
				//				port);

				//hard code to use localport 1243
				localAddr = new SessionAddress( InetAddress.getLocalHost(),
						1243);
